...
<!-- Mirrored from citybook.kwst.net/footer-fixed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Apr 2018 17:36:15 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script type="text/javascript" src="{{assert('plugins.js')}}"></script>
        <script type="text/javascript" src="{{assert('scripts.js')}}"></script>
    </body>
